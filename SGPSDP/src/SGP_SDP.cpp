...
namespace SGPSDP
{
    SGPSDP_OrbitalPropagator::SGPSDP_OrbitalPropagator()
    {
        for (double &p : params)
        {
            p = 0.0;
    ...
    void SGPSDP_OrbitalPropagator::Initialize()
    {
    ...
    // private
    int SGPSDP_OrbitalPropagator::SelectEphemeris()
    {
...
#define c6 params[10]
    ...
    void SGPSDP_OrbitalPropagator::SGP_init()
    {
    ...
    // void SGPSDP_OrbitalPropagator::SGP( const double tsince, const tle_t *tle, const double *params,
    //           double *pos, double *vel)
    void SGPSDP_OrbitalPropagator::SGP(double tsince)
    {
...
#define MINIMAL_E 1.e-9
    ...
    void SGPSDP_OrbitalPropagator::SGP4_init()
    {
        deep_arg_t deep_arg;
        init_t init;
        double eeta, etasq;
    ...
    // void SGPSDP_OrbitalPropagator::SGP4( const double tsince, const tle_t *tle, const double *params,
    //                                                     double *pos, double *vel)
    void SGPSDP_OrbitalPropagator::SGP4(double tsince)
    {
        ...
        sxpx_posn_vel(xnode, a, e, params, p_cosio, p_sinio, tle->xincl, omega, xl, mPos, mVel);
    } // SGP4
...
#define deep_arg ((deep_arg_t *)(params + 9))
    ...
    void SGPSDP_OrbitalPropagator::SDP4_init()
    {
        init_t init;
    ...
    //                                          double *pos, double *vel)
    void SGPSDP_OrbitalPropagator::SDP4(double tsince)
    {
...
#define xnodp params[23]
    ...
    void SGPSDP_OrbitalPropagator::SGP8_init()
    {
    ...
    //                                           double *pos, double *vel)
    void SGPSDP_OrbitalPropagator::SGP8(double tsince)
    {
        int i;
...
#define deep_arg ((deep_arg_t *)(params + 11))
    ...
    void SGPSDP_OrbitalPropagator::SDP8_init()
    {
    ...
    //                                 double *pos, double *vel)
    void SGPSDP_OrbitalPropagator::SDP8(double tsince)
    {
